...
import com.bolsadeideas.springboot.backend.apirest.models.services.ICompanyService;
...
public class CompanyRestController {
	...
	@Autowired
	private ICompanyService compaService;
	...
	public ResponseEntity<?> show(@PathVariable String cia) {
		...
		try {
			company = compaService.findCompany(cia);
	...
	public List<Company> listar() {
		return compaService.getAllCompany(); 
	}
